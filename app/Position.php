...
class Position extends Model
{
    ...
    protected $fillable = ['name', 'accessEmail', 'accessPin', 'description', 'company_id', 'key_position_id'
    ];

    public static function createFirst($company): Position
    {
        $key = KeyPosition::latest()->where('key', '=', 'super_manager')->where('company_id', '=', 'null')->get()[0];
