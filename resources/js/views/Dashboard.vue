      ...
      >
        ...
        >
          <linear-statistic
            ...
            :sub-title="
              $vuetify.lang.t('$vuetify.dashboard.salesSub')
            "
            :currency="getCurrency"
            :quantity="
              salesStatics.totalSales
                ? salesStatics.totalSales.toString()
                : 0
            "
        ...
        >
          <linear-statistic
            ...
            :sub-title="
              $vuetify.lang.t('$vuetify.dashboard.ordersSub')
            "
            :quantity="
              salesStatics.totalOrders
                ? salesStatics.totalOrders.toString()
                : 0
            "
            icon="mdi-trending-up"
            color="info"
        ...
        >
          <linear-statistic
            ...
            :sub-title="
              $vuetify.lang.t('$vuetify.dashboard.revenueSub')
            "
            :currency="getCurrency"
            :quantity="
              salesStatics.totalRevenue
                ? salesStatics.totalRevenue.toString()
                : 0
            "
            icon="mdi-trending-up"
            color="primary"
        ...
        >
          <linear-statistic
            ...
            :sub-title="
              $vuetify.lang.t('$vuetify.dashboard.costsSub')
            "
            :currency="getCurrency"
            :quantity="
              salesStatics.totalExpenses
                ? salesStatics.totalExpenses.toString()
                : 0
            "
...
export default {
  ...
  computed: {
    ...
    getCurrency () {
      return this.user ? this.user.company.currency : ''
    }
  },
  watch: {
    ...
    completeStaticTic () {
      ...
      if (this.access_permit.length > 0) {
        this.access_permit.filter(
          permit => permit.title.name === 'manager_shop'
        )[0].title.value === true
          ? this.statistic.push({
            icon: 'mdi-home',
        ...
        this.access_permit.filter(
          permit => permit.title.name === 'manager_category'
        )[0].title.value === true
          ? this.statistic.push({
            icon: 'mdi-tag',
            sub_title: this.$vuetify.lang.t(
        ...
        this.access_permit.filter(
          permit => permit.title.name === 'manager_article'
        )[0].title.value === true
          ? this.statistic.push({
            icon: 'mdi-shopping',
            sub_title: this.$vuetify.lang.t(
        ...
        this.access_permit.filter(
          permit => permit.title.name === 'manager_mod'
        )[0].title.value === true
          ? this.statistic.push({
        ...
        this.access_permit.filter(
          permit => permit.title.name === 'manager_client'
        )[0].title.value === true
          ? this.statistic.push({
        ...
        this.access_permit.filter(
          permit => permit.title.name === 'manager_boxes'
        )[0].title.value === true
          ? this.statistic.push({
            icon: 'mdi-database',
            sub_title: this.$vuetify.lang.t(
        ...
        this.access_permit.filter(
          permit => permit.title.name === 'manager_refunds'
        )[0].title.value === true
          ? this.statistic.push({
            icon: 'mdi-undo',
            sub_title: this.$vuetify.lang.t(
        ...
        this.access_permit.filter(
          permit => permit.title.name === 'manager_vending'
        )[0].title.value === true
          ? this.statistic.push({
            icon: 'mdi-currency-usd',
            sub_title: this.$vuetify.lang.t(
        ...
        this.access_permit.filter(
          permit => permit.title.name === 'manager_buy'
        )[0].title.value === true
          ? this.statistic.push({
            icon: 'mdi-cart',
            sub_title: this.$vuetify.lang.t(
        ...
        this.access_permit.filter(
          permit => permit.title.name === 'manager_sell'
        )[0].title.value === true
          ? this.statistic.push({
            icon: 'mdi-chart-bar',
            sub_title: this.$vuetify.lang.t(
        ...
        this.access_permit.filter(
          permit => permit.title.name === 'manager_access'
        )[0].title.value === true
          ? this.statistic.push({
            icon: 'mdi-key',
            sub_title: this.$vuetify.lang.t(
        ...
        this.access_permit.filter(
          permit => permit.title.name === 'manager_employer'
        )[0].title.value === true
          ? this.statistic.push({
        ...
        this.access_permit.filter(
          permit => permit.title.name === 'manager_payment'
        )[0].title.value === true
          ? this.statistic.push({
            icon: 'mdi-cash-multiple',
            sub_title: this.$vuetify.lang.t(
              '$vuetify.access.access.manager_payment'
            ),
            goToClick: 'pay'
          })
          : this.statisticDeny.push({
        ...
        this.access_permit.filter(
          permit => permit.title.name === 'manager_expense_category'
        )[0].title.value === true
          ? this.statistic.push({
        ...
        this.access_permit.filter(
          permit => permit.title.name === 'manager_exchange_rate'
        )[0].title.value === true
          ? this.statistic.push({
            icon: 'mdi-bank',
            sub_title: this.$vuetify.lang.t(
        ...
        this.access_permit.filter(
          permit => permit.title.name === 'manager_type_of_order'
        )[0].title.value === true
          ? this.statistic.push({
            icon: 'mdi-food',
            sub_title: this.$vuetify.lang.t(
        ...
        this.access_permit.filter(
          permit => permit.title.name === 'manager_tax'
        )[0].title.value === true
          ? this.statistic.push({
            icon: 'mdi-wallet',
            sub_title: this.$vuetify.lang.t(
        ...
        this.access_permit.filter(
          permit => permit.title.name === 'manager_discount'
        )[0].title.value === true
          ? this.statistic.push({
            icon: 'mdi-cash-minus',
            sub_title: this.$vuetify.lang.t(
