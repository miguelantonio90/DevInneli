<template>
    <v-dialog
        ...
        scrollable v-model="toogleNewModal">
        <v-card>
            <v-card-title>
        <span class="headline">{{
            ...
            <v-card-text>
                <v-form v-if="validShow"
                        ref="form"
                        v-model="formValid"
                        style="padding: 0px"
                        lazy-validation
                >
                    <v-expansion-panels style="margin: 0px" v-model="panel" multiple>
                        <v-row>
                            <v-col cols="12" md="6">
                                                ...
                                                <v-row>
                                                    <v-col cols="12" md="6">
                                                        <v-checkbox
                                                            ...
                                                            class="md-6" @change="changeComposite"
                            ...
                            <v-expansion-panel-content>
                                <v-row>
                                    <v-col cols="12" md="12">
                                        <v-row>
                                            <v-col  cols="12" md="12">
                                                <variant v-on:updateVariants="updateVariant"/>
                                            </v-col>
                                        </v-row>
                                    </v-col>
                                </v-row>
