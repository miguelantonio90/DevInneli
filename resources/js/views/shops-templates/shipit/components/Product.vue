    ...
    <v-container>
      <div class="row">
        <div class="col-md-5 col-sm-5 col-xs-12">
          <v-carousel>
            <v-carousel-item
              src="../assets/shop/shop/img/home/slider4.jpg"
            />
            <v-carousel-item
              src="../assets/shop/shop/img/home/slider2.jpg"
            />
            <v-carousel-item
              src="../assets/shop/shop/img/home/slider3.jpg"
            />
            <v-carousel-item
              src="../assets/shop/shop/img/home/slider1.jpg"
            />
          </v-carousel>
        </div>
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <v-list-item-content>
                    <v-list-item-title>{{ item.title }}</v-list-item-title><v-rating
                      v-model="rating"
                      class=""
                      background-color="warning lighten-3"
                      color="warning"
      ...
      <v-container>
        <v-row no-gutters>
          <v-col class="col-12 col-md-4 col-sm-12">
            <v-row>
              <v-col
                class="col-12 col-sm-3 pr-4 hidden-sm-only"
                align="right"
              >
