              ...
              <v-expansion-panel-content>
                <v-row>
                  <v-col
                    ...
                    cols="12"
                    :md="
                      localSalesByCategories.length > 0
                        ? 4
                        : 12
                    "
                  >
                    ...
                    >
                      <v-list dense>
                        <v-subheader>
                          {{
                            localSalesByCategories.length >
                              0
                              ? $vuetify.lang.t(
                                "$vuetify.report.top5Category"
                              )
                              : $vuetify.lang.t(
                        ...
                        >
                          <v-list-item
                            v-for="(item,
                                    i) in localSalesByCategories.slice(
                                      0,
                                      5
                                    )"
                            :key="i"
  ...
  methods: {
    ...
    async loadSalesByCategories () {
      await this.getSalesByCategories({
        ...
        this.localSalesByCategories = this.salesByCategories.sort(
          function (a, b) {
