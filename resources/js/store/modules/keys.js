  ...
  newKey: {
    ...
    access_permit: [
	  ...
	  },
	  {
        ...
        actions: [
		  { sell_by_product: false },
		  { sell_by_category: false },
		  { sell_by_employer: false },
		  { sell_by_payments: false }
        ]
	  },
	  {
        title: {
	  ...
	  },
	  {
        ...
        actions: [
		  { assistance_list: false },
		  { assistance_add: false },
		  { assistance_edit: false },
		  { assistance_delete: false }
        ]
	  },
	  {
        title: {
	  ...
	  },
	  {
        ...
        actions: [
		  { expense_category_list: false },
		  { expense_category_add: false },
		  { expense_category_edit: false },
		  { expense_category_delete: false }
        ]
	  },
	  {
        title: {
        ...
        actions: [
		  { exchange_rate_list: false },
		  { exchange_rate_add: false },
		  { exchange_rate_edit: false },
		  { exchange_rate_delete: false }
        ]
	  },
	  {
        title: {
        ...
        actions: [
		  { type_of_order_list: false },
		  { type_of_order_add: false },
		  { type_of_order_edit: false },
		  { type_of_order_delete: false }
        ]
	  },
	  {
        title: {
...
const mutations = {
  ...
  [KEY_EDIT] (state, keyId) {
    state.editKey = Object.assign(
	  {},
	  state.keys.filter(node => node.id === keyId).shift()
    )
