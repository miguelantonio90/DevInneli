...
export default {
  ...
  access: {
    ...
    access: {
      ...
      article_list: 'Ver Lista de Artículos',
      article_add: 'Adicionar Nuevo de Artículos',
      ...
      category_list: 'Ver Lista de Categorías',
      category_add: 'Adicionar Nueva Categoría',
      category_edit: 'Editar Categoría',
      category_delete: 'Eliminar Categoría',
      mod_list: 'Ver Lista de Modificadores',
      mod_add: 'Adicionar Nuevo Modificador',
      mod_edit: 'Editar Modificador',
      mod_delete: 'Eliminar Modificador',
      supplier_list: 'Ver Lista de Proveedor',
      supplier_add: 'Adicionar Nuevo Proveedor',
      supplier_edit: 'Editar Proveedor',
      supplier_delete: 'Eliminar Proveedor',
      buy_list: 'Ver Lista de Compras',
      buy_add: 'Adicionar Nueva Compra',
      buy_edit: 'Editar Compa',
      buy_delete: 'Eliminar Compa',
      ...
      employer_list: 'Ver Lista de Empleados',
      employer_add: 'Adicionar Nuevo Empleado',
      employer_edit: 'Editar Empleado',
      employer_delete: 'Eliminar Empleado',
      assistance_list: 'Ver Lista de Tarjeta de asistencia',
      ...
      client_list: 'Ver Lista de Cliente',
      client_add: 'Adicionar Cliente',
      client_edit: 'Editar Cliente',
      client_delete: 'Eliminar Cliente',
      config: 'Configuración',
      shop_list: 'Ver Lista de Cliente',
      shop_add: 'Adicionar Cliente',
      shop_edit: 'Editar Cliente',
      shop_delete: 'Eliminar Cliente',
      access_list: 'Ver Lista de Cliente',
      access_add: 'Adicionar Cliente',
      access_edit: 'Editar Cliente',
      access_delete: 'Eliminar Cliente',
      payment_list: 'Ver Lista de Métodos de Pagos',
      payment_add: 'Adicionar Métodos de Pago',
      payment_edit: 'Editar Métodos de Pago',
      payment_delete: 'Eliminar Métodos de Pago',
      expense_category_list: 'Ver Lista de Métodos de Pagos',
      expense_category_add: 'Adicionar Métodos de Pago',
      expense_category_edit: 'Editar Métodos de Pago',
      expense_category_delete: 'Eliminar Métodos de Pago',
      exchange_rate_list: 'Ver Lista de Métodos de Pagos',
